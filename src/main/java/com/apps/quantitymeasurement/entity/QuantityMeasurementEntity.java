...
public class QuantityMeasurementEntity implements java.io.Serializable {
	...
	/*
	 * Constructor for comparison or conversion operations Example: 1 ft == 12 in
	 */
	...
	/*
	 * Constructor for arithmetic operations Example: 1 ft + 12 in = 2 ft
	 */
	public QuantityMeasurementEntity(double thisValue, String thisUnit, String thisMeasurementType, double thatValue,
	...
	public boolean equals(Object obj) {
		...
		return Double.compare(that.thisValue, thisValue) == 0 && Double.compare(that.thatValue, thatValue) == 0
				&& Double.compare(that.resultValue, resultValue) == 0 && isError == that.isError
				...
				&& Objects.equals(operation, that.operation) && Objects.equals(resultUnit, that.resultUnit)
				&& Objects.equals(resultMeasurementType, that.resultMeasurementType)
				&& Objects.equals(resultString, that.resultString) && Objects.equals(errorMessage, that.errorMessage);
	}
	...
	public static void main(String[] args) {
		QuantityMeasurementEntity entity = new QuantityMeasurementEntity(1, "Feet", "Length", 12, "Inch", "Length",
				"COMPARE", "Equal");
